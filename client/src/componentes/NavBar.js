    ...
    <div style={ styleNavBar } className="bg-primary flex flex-row justify-around sm:ustify-between mr-3">
      ...
      <div className="flex flex-row justify-end">
        ...
        <div className=" m-5  pt-1 sm:pt-0">
          ...
          <button onClick={ () => dispatch(toggleCart()) } className="btn btn-outline text-white btn-sm sm:btn-md">{ <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
