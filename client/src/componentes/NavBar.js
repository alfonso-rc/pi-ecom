  ...
  return (
    <div style={ styleNavBar } className="bg-slate-800 flex flex-row justify-between mr-3">
      ...
      <div className=" m-5">
        ...
        <button onClick={ () => dispatch(toggleCart()) } className="btn btn-outline btn-accent">{ <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
