    ...
    <div style={ styleNavBar } className="bg-primary flex place-content-around md:place-content-between pl-3">
        ...
        sessionStorage.name ? <div className='w-auto'><Profile/></div> : <LoginAuth0/>
            ...
            <div className="my-5  sm:m-5">
                ...
                <button onClick={ () => dispatch(toggleCart()) } className="btn btn-outline text-white">{ <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
