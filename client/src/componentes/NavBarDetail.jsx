...
export default function NavBarDetail() {
  ...
  return (
    <div style={ styleNavBar } className="bg-slate-800 flex place-content-between mr-3">
        <Link to="/home" className='flex'><img style={ { alignSelf: "center", marginLeft: "5px" } } src={ Log2 } alt="Logo" className="w-46 h-16" /></Link>
