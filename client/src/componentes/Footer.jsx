    ...
    return(
        <div >
            <footer class="footer bg-base-200 text-base-content flex flex-row flex-wrap items-center justify-around py-4">
                ...
                <div>
                    <span class="footer-title link link-hover">Politica de privacidad</span> 
                </div> 
                <div>
                    <span class="footer-title link link-hover">Terminos y condiciones</span> 
                </div>
                <div>
                    <span class="footer-title link link-hover">Acerca de nosotros</span> 
                </div> 
            </footer>
        </div>
    )
