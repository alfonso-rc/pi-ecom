         ...
         Este trabajo deja mostrar la logica y la forma que se veria un E-COMERCE. 
            ...
            <div>
               ...
               <p className="flex py-6 text-start text-sm sm:text-base md:text-lg">
                  Ecom es un Ecommerse de articulos de tecnología desarrollada
                  sobre la premisa de una simulacion de un proyecto grupal en un
                  ambito laboral, con el cual quisimos sacar nuestro mayor
                  provecho de nuestros conocimientos aprendidos en la academia de
                  Henry. Es por eso que nuestro modelo se basa en un Ecommerse ya
                  que tiene funcionalidades tanto como en el front como en el back
                  igual de complejas y implementar nuevas tecnologias aprendidas
                  en el trayecto. Nos asociamos con nuestros compañeros de trabajo
                  para diseñar los primeros productos electronicos para clientes.
                  Esto para crear un mercado tecnologico con opciones mejores y
                  estilizado lo mas amigable para el cliente. De forma de practica
                  pudimos demostrar en lo que ustedes ven ahora mismo como nuestro
                  Proyecto Final o como el Primero de muchos.
               </p>
               <img
