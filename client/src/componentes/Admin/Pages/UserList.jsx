              ...
              return (
                <tr>
                  ...
                  <th>
                    {!usr.ban ? (
                      <div>
                      <button className="btn btn-success btn-xs" onClick={() =>handleClickBaned(usr.id)}>NoBanned</button>
                      </div>
                    ) : (
                      <div>
                      <button className="btn btn-error btn-xs" onClick={() =>handleClickBaned(usr.id)}>Banned</button>
                      </div>
                    )}
                  </th>
                  <th>
