...
import { postArticle, getCategory, getArticles, editArticle } from "../../../store/actions/index";
    ...
    <div>
      ...
      <div className="text-black">
        <form onSubmit={(e) => handleSubmit(e)} className="">
          <h1 className="text-3xl m-5 border-b-2 border-b-zinc-300 rounded-lg border font-Work font-bold shadow-2xl">EDIT ARTICLE</h1>
          { artic ? (
            <div>
